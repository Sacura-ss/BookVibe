...
import com.example.bookvibe.databinding.ActivityPdfViewBinding;
...
public class PdfViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //get bookId from intent we passed in intent
                ...
                .addOnSuccessListener(new OnSuccessListener<byte[]>() {
                    ...
                    public void onSuccess(byte[] bytes) {
                        ...
                        binding.pdfView.fromBytes(bytes)
                                .swipeHorizontal(false) //scroll vertical false, true for swipe horizontal
                                .onPageChange(new OnPageChangeListener() {
                                    @Override
                                    public void onPageChanged(int page, int pageCount) {
                                        //set current and total pages in toolbar subtitle
                                        int currentPage = (page + 1); //+1 because page starts from 0
                                        binding.toolbarSubtitleTv.setText(currentPage + "/" + pageCount); //e.g. 5/250
