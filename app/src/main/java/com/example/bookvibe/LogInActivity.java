...
import com.example.bookvibe.databinding.ActivityLogInBinding;
...
public class LogInActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //handle click, go Sign Up
        binding.upSignupBtn.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void validateData() {
        /*Before log in account? do some data validation*/
